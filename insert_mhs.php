...
<body>
    <h2 align="center">PENAMBAHAN DATA ANGGOTA</h2>
        ...
        <div class="col-lg-6 m-auto">
            <div class="card mt-5">
                <div class="card-title">
                    <h3 class="bg-success text-white text-center py-3"> Input Data Anggota</h3>
                </div>
                <div class="card-body">

                    <form action="insertdata.php" method="post">
                        <input type="text" class="form-control mb-2" placeholder=" NRP " name="nrp">
                        <input type="text" class="form-control mb-2" placeholder=" Nama " name="nama">
                        <input type="text" class="form-control mb-2" placeholder=" Jenis Kelamin " name="kelamin">
                        <input type="text" class="form-control mb-2" placeholder=" Tanggal Lahir " name="tgllahir">
                        <input type="text" class="form-control mb-2" placeholder=" Alamat " name="alamat">
                        <input type="text" class="form-control mb-2" placeholder=" Nomer HP " name="nohp">
