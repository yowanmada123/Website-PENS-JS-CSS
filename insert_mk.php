...
<body>
    <h2 align="center">PENAMBAHAN DATA BUKU</h2>
        ...
        <div class="col-lg-6 m-auto">
            <div class="card mt-5">
                ...
                <div class="card-body">
                    ...
                    <form action="insertdatamk.php" method="post">
                        ...
                        <input type="text" class="form-control mb-2" placeholder=" Pengarang " name="pengarang">
                        <input type="text" class="form-control mb-2" placeholder=" Penerbit " name="penerbit">
